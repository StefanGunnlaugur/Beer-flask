...
for i in range(120):
    ...
    for product in soup.find_all('li', class_="product"):
        if product.find('span', class_="category"):
        ...
        if product.find('span', class_="volume"):
            volume = product.find('span', class_="volume").text
        else:
            volume = ''

        if product.find('span', class_="alcohol"):
            alcohol = product.find('span', class_="alcohol").text  
        else:
            alcohol = ''

        if product.find('span', class_="product-number"):
        ...
        if product.find('span', class_="text"):
            drink_type = product.find('span', class_="text").text  
        else:
            drink_type = ''
        print(title)
        if product.find('span', class_="taste"):
