...
from skal.db import (resolve_order, add_beer_rating, add_beer_comment, 
                    ...
                    make_beernightbeer)
from skal.forms import ( BeerEditForm, BeernightForm, CopyBeernightForm, 
...
def add_beer_to_beernight(id, beernight_id):
    try:
        ...
        if(beernight):
            flash('Bjór bætt við smökkun',
                    category="success")
        else:
            flash('Ekki tókst að bæta bjór við smökkun',
                    category="warning")
...
def delete_beer_from_beernight(id, beernight_id):
    try:
        ...
        if(beernight):
            flash('Bjór var fjarlægður úr smökkuni',
                    category="success")
        else:
            flash('Ekki tókst að fjarlægja bjór úr smökkuni',
                    category="warning")
        return redirect(url_for('beernight.beernight_detail', id=beernight_id))
    except Exception as error:
        flash('Ekki tókst að senda athugasemd',
